    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">13 قطاع للمغتربين حول العالم</p>
        </div>
        <button
          onClick={() => {
            setShowForm(true);
        ...
        <div className="mt-6 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">إجمالي القطاعات</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">
                {regions.filter(r => r.active).length}
              </div>
              <div className="text-sm text-gray-600">القطاعات الفعالة</div>
            </div>
            <div className="text-center">
